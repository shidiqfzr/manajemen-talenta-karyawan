...
<div class="max-w-5xl mx-auto p-6 bg-white rounded-xl shadow-lg space-y-8">
    <h1 class="text-2xl font-bold text-center mb-6">Edit Data Pelatihan</h1>
    ...
    <form action="{{ route('admin.trainings.update', $training->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="jam_belajar_per_hari" value="{{ old('jam_belajar_per_hari', $training->jam_belajar_per_hari) }}" class="w-full border rounded px-3 py-2">
            </div>
        </div>
